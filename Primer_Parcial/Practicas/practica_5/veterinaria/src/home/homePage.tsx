	...
	return (
		<>
			<section className="bg-blue-500 text-white p-8">
				...
				<button className="bg-white text-blue-500 px-4 py-2 mt-4 rounded-full hover:bg-blue-200 transition duration-300 ease-in-out">
					Agenda una cita
				</button>
			</section>
				...
				<div className="container mx-auto">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div className="bg-white p-4 rounded-lg shadow-md">
							...
							<p className="text-blue-500 mt-4">- Nombre del Cliente</p>
						</div>
						<div className="bg-white p-4 rounded-lg shadow-md">
							<blockquote className="text-gray-700">
								"El personal es amable y atento, y las instalaciones son impecables."
							</blockquote>
							<p className="text-blue-500 mt-4">- Otro Cliente Satisfecho</p>
						</div>
					</div>
				</div>
			</section>
